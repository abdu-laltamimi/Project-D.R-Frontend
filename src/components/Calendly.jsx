  ...
  return (
    ...
    <div className="flex flex-col md:flex-row items-center gap-12 max-w-7xl mx-auto">
      ...
      <div className="w-full xl:w-1/2 rounded-lg overflow-hidden">
        <InlineWidget url="https://calendly.com/abdul-alt-seamlessideas/15min?hide_gdpr_banner=1" styles={{ width: "100%", height: "600px" }} pageSettings={{ hideEventTypeDetails: false, backgroundColor: "#FFFAFA",   }} />
      </div>
    </div>
  </div>
  );
