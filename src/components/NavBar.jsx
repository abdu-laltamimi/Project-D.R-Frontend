        ...
        <div className="max-w-[1400px] mx-auto">
          <div className="flex items-center justify-between h-auto">
            ...
            <div className="flex items-center gap-4 md:flex-row md:gap-18 md:pr-8">
              ...
              <a href="mailto:contact@mymaternalhub.co.uk" className="text-white text-md md:block tracking-wider font-light hover:opacity-70 bg-[#003845] transition-opacity rounded-full px-6  py-2 ">
                Contact Us
              </a>
            </div>
          </div>
